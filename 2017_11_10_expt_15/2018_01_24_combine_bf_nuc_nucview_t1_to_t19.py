...
if __name__ == "__main__":
    ...
    for ste in sites:
        ...
        if len(channels) == 3:
            h5Filename3 = os.path.join('{sbdr}', 'Well'+well[0]+'_'+ste+'c3_t1_to_t19.h5')
        elif len(channels) == 4:
            h5Filename3 = os.path.join('{sbdr}', 'Well'+well[0]+'_'+ste+'c4_t1_to_t19.h5')
        elif len(channels) == 5:
            h5Filename3 = os.path.join('{sbdr}', 'Well'+well[0]+'_'+ste+'c5_t1_to_t19.h5')
    ...
    #        print (axistags)
        ...
        outputFilename = os.path.join('{sbdr}', 'Well'+well[0]+'_'+ste+'_bf_nuc_nucview_t1_to_t19.h5')
...
if __name__ == "__main__":
    ...
    master_script_path = os.path.join(codeDirectory, 'combine_bf_nuc_nucview_t1_to_t19_master_script')
