...
if __name__ == "__main__":
    ...
    #        print (axistags)
        ...
        outputFilename = os.path.join('{sbdr}', 'Well'+well[0]+'_'+ste+'c1-2_t20_to_tend.h5')
...
if __name__ == "__main__":
    ...
    master_script_path = os.path.join(codeDirectory, 'combine_c1_c2_t20_to_tend_master_script')
