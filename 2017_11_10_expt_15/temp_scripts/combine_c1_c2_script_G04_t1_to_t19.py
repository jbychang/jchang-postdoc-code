...
if __name__ == "__main__":
    ...
    for ste in sites:
        h5Filename1 = os.path.join('/awlab/users/jchang/raw_data/2017_11_10_expt_15_SK_dose_response_h5/G04', 'Well'+well[0]+'_'+ste+'c1_t1_to_t19.h5')
        h5Filename2 = os.path.join('/awlab/users/jchang/raw_data/2017_11_10_expt_15_SK_dose_response_h5/G04', 'Well'+well[0]+'_'+ste+'c2_t1_to_t19.h5')
        if len(channels) == 3:
            h5Filename3 = os.path.join('/awlab/users/jchang/raw_data/2017_11_10_expt_15_SK_dose_response_h5/G04', 'Well'+well[0]+'_'+ste+'c3_t1_to_t19.h5')
        elif len(channels) == 4:
            h5Filename3 = os.path.join('/awlab/users/jchang/raw_data/2017_11_10_expt_15_SK_dose_response_h5/G04', 'Well'+well[0]+'_'+ste+'c4_t1_to_t19.h5')
        elif len(channels) == 5:
            h5Filename3 = os.path.join('/awlab/users/jchang/raw_data/2017_11_10_expt_15_SK_dose_response_h5/G04', 'Well'+well[0]+'_'+ste+'c5_t1_to_t19.h5')
    ...
    #        print (axistags)
        ...
        outputFilename = os.path.join('/awlab/users/jchang/raw_data/2017_11_10_expt_15_SK_dose_response_h5/G04', 'Well'+well[0]+'_'+ste+'_bf_nuc_nucview_t1_to_t19.h5')
