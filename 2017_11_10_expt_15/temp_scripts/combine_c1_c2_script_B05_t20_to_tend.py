...
if __name__ == "__main__":
    ...
    print('Now processing directory '+'/awlab/users/jchang/raw_data/2017_11_10_expt_15_SK_dose_response_h5/B05')
    os.chdir('/awlab/users/jchang/raw_data/2017_11_10_expt_15_SK_dose_response_h5/B05')
    
    pattern = re.compile(r'Well([A-Z]\d\d)_(\d\d\d\d)c([0-9])_t20_to_tend.h5') 
    allFiles = os.listdir('/awlab/users/jchang/raw_data/2017_11_10_expt_15_SK_dose_response_h5/B05')
    ...
    for ste in sites:
        h5Filename1 = os.path.join('/awlab/users/jchang/raw_data/2017_11_10_expt_15_SK_dose_response_h5/B05', 'Well'+well[0]+'_'+ste+'c1_t20_to_tend.h5')
        h5Filename2 = os.path.join('/awlab/users/jchang/raw_data/2017_11_10_expt_15_SK_dose_response_h5/B05', 'Well'+well[0]+'_'+ste+'c2_t20_to_tend.h5')
        if len(channels) == 3:
            h5Filename3 = os.path.join('/awlab/users/jchang/raw_data/2017_11_10_expt_15_SK_dose_response_h5/B05', 'Well'+well[0]+'_'+ste+'c3_t20_to_tend.h5')
        elif len(channels) == 4:
            h5Filename3 = os.path.join('/awlab/users/jchang/raw_data/2017_11_10_expt_15_SK_dose_response_h5/B05', 'Well'+well[0]+'_'+ste+'c4_t20_to_tend.h5')
        elif len(channels) == 5:
            h5Filename3 = os.path.join('/awlab/users/jchang/raw_data/2017_11_10_expt_15_SK_dose_response_h5/B05', 'Well'+well[0]+'_'+ste+'c5_t20_to_tend.h5')
    ...
    #        print (axistags)
        ...
        outputFilename = os.path.join('/awlab/users/jchang/raw_data/2017_11_10_expt_15_SK_dose_response_h5/B05', 'Well'+well[0]+'_'+ste+'_bf_nuc_nucview_t20_to_tend.h5')
