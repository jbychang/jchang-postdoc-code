...
with open('/awlab/users/jchang/code/2017_11_10_expt_15/temp_scripts/cluster_script_ilastik_pixclass_2018_01_24', 'w') as f:
    for subDir in subDirectories:
        directory = os.path.join(parentDirectory, subDir)
        print('in directory ' + directory)
        h5Files = glob.glob(os.path.join(directory, r'*bf_nuc_nucview*.h5'))
        print(r'found the following *bf_nuc_nucview*.h5 files: ' + str(h5Files))
        for h5File in h5Files:
            f.write('/awlab/users/jchang/programs/ilastik-1.3.0b4-Linux/run_ilastik.sh --headless --project=/awlab/users/jchang/code/2017_11_10_expt_15/2018_01_17_ilastik_13b4_pixclass_with_nucview_retrained.ilp '+ os.path.join(directory, h5File)+'\n')
