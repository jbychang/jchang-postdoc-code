...
with open('/awlab/users/jchang/code/2018_03_27_expt_18/temp_scripts/cluster_script_ilastik_auto_tracking_2018_05_02', 'w') as f:
    for subDir in subDirectories:
        ...
        for h5File, probabilityFile in zip(h5Files, probabilityFiles):
            f.write('/awlab/users/jchang/programs/ilastik-1.3.0-Linux/run_ilastik.sh --headless --project=/awlab/users/jchang/code/2018_03_27_expt_18/2018_05_01_ilastik_autotracking_expt18.ilp --raw_data='+ os.path.join(directory, h5File)+' --prediction_maps='+ os.path.join(directory, probabilityFile) + r' --export_source="Object-Identities" --output_filename_format={dataset_dir}\{nickname}_{result_type}'+'\n')
