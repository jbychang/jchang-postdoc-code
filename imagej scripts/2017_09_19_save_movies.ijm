...
fields = newArray("C02_0000", "D02_0000", "E02_0000", "G02_0000", "C05_0000", "D05_0000", "E05_0000", "G05_0000", "B06_0000", "C06_0000", "D06_0000", "E06_0000", "G06_0000", "C08_0000", "D08_0000", "E08_0000", "G08_0000", "C02_0001", "D02_0001", "E02_0001", "G02_0001", "C05_0001", "D05_0001", "E05_0001", "G05_0001", "C06_0001", "D06_0001", "E06_0001", "G06_0001", "C08_0001", "D08_0001", "E08_0001", "G08_0001");
...
run("Image Sequence...", "open=Y:\\JC_2017_09_16_ex8_BT_lap\\JC_2017_09_16_ex8_BT_lapt001B02_0000c2.tif file=(.*"+fields[i]+"c[23].*) sort");
rename("cells");
...
run("Merge Channels...", "c1=[cells #2] c2=[cells #1] create keep");
...
run("AVI... ", "compression=JPEG frame=7 save="+dir2+"JC_2017_09_16_ex8_BT_lap_KTR_apop"+fields[i]+".avi");
run("Close All");
};
