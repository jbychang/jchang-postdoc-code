...
run("Merge Channels...", "c1=[cells #3] c2=[cells #2] c5=[cells #1] create keep");
...
run("AVI... ", "compression=JPEG frame=7 save="+dir2+"JC_2017_09_13_SKBr3BFP_nophase_"+fields[i]+".avi");
run("Close All");
};
...
fields = newArray("B02_0000", "B03_0000", "B04_0000", "B05_0000", "B06_0000", "B07_0000", "B08_0000");
