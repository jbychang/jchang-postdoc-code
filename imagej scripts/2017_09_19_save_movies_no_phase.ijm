...
fields = newArray("C02_0000", "D02_0000", "E02_0000", "F02_0000", "G02_0000", "C04_0000", "D04_0000", "E04_0000", "F04_0000", "G04_0000", "C05_0000", "D05_0000", "E05_0000", "F05_0000", "G05_0000", "C06_0000", "D06_0000", "E06_0000", "F06_0000", "G06_0000", "C07_0000", "D07_0000", "E07_0000", "F07_0000", "G07_0000", "C08_0000", "D08_0000", "E08_0000", "F08_0000", "G08_0000");
...
run("Image Sequence...", "open=[Z:\\2017_09_13 SK BFP lap\\2017_09_13_ex7_SK_lapt004B07_0001c3.tif] file=(.*"+fields[i]+"c[23].*) sort");
rename("cells");
...
run("AVI... ", "compression=JPEG frame=7 save="+dir2+"JC_2017_09_13_SKBr3BFP_KTR_apop_"+fields[i]+".avi");
run("Close All");
};
