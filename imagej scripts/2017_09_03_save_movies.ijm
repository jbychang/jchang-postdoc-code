...
run("Image Sequence...", "open=E:\\Jeremy\\JC_170816_BT474_plate_2017026103_tlapse_all_img\\JC_20170816_plate_2017026103_tlapse2_15m_t157_H4_0000-1.tif file=(.*tlapse2_15m.*"+fields[i]+".*) convert sort");
rename("cells");
...
run("AVI... ", "compression=JPEG frame=7 save="+dir2+"JC_20170816_plate_2017026103_tlapse2_15m_"+fields[i]+".avi");
run("Close All");
};